\section{Unidad 06 - Mineria de Datos}
La minería de datos analiza datos y extrae patrones o
información interesante (no trivial, implícita, previamente
desconocida y potencialmente util) de dichos datos, la
minería no realiza suposiciones sino que trata de descubrir
relaciones y patrones escondidos que no son siempre obvios.
...
los utilizamos para las tareas que necesitemos. En cambio las
herramientas de minería van a tratar de determinar el porque sucedio
esto y no solo con los datos de la produccíon sino por ejemplo con
los datos climáticos, datos relacionados con el mantenimiento de las
plantas, etc. 
...
conjunto de datos de entrenamiento previamente etiquetados. Por
etiquetado entendemos que para cada ocurrencia del conjunto de datos
de entrenamiento conocemos el valor de el atributo objetivo. Esto le
...
La minería de datos puede ser aplicada en distintas áreas dentro de
una organización.

\subsubsection{Marketing}
Se utiliza para analizar patrones en las compras de los clientes.
...
\subsection{Compresión del Model}
...
Se intenta extraer información de como el usuario utiliza el sitio
web (áreas más utilizados, links más utilizados, tiempo de uso del
sitio) a partir de las sesiones y comportamientos de los usuarios y
navegantes.
